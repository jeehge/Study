...
- [x] 24.01.03(수) section 5

- [x] 24.01.13(토) section 7

- [x] 24.01.23(화) section 8 공부만 진행 -> 다음에 발표시간 갖기로함

- [x] 24.02.02(금) section 8 모여서 공부 zedd 님 블로그로 학습 완료!

- [ ] 24.02.14(수) section 9 미리 읽어오기 
