...
struct WaterWidgetLiveActivity_Previews: PreviewProvider {
    static let attributes = WaterWidgetAttributes(name: "Me")
    static let contentState = WaterWidgetAttributes.ContentState(value: 3)
